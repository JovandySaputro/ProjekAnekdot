...
val appQuestions = arrayListOf<Question>(
    ...
    Question(question = "Sindiran dalam teks anekdot dapat diungkapkan dengan antonim. Pasangan kata dibawah ini yang merupakan antonim, kecuali ...", difficulty = medium, optionA = "Adil – Tidak adil", optionB = "Kaya – Miskin", optionC = "Target – Sasaran", answer = c),
    Question(question = "Anekdot yaitu jenis teks yang berisi .... lucu, konyol, atu menjengkelakan seabgai akibaat dari krisis yang di tanggapi dengan reaksi, adalah ....", difficulty = medium, optionA = "Pertanyaan-pertanyaan", optionB = "Peristiwa-peristiwa", optionC = "Kalimat-kalimat", answer = b),
    Question(question = "Ciri-ciri anekdot yaitu, kecuali....", difficulty = medium, optionA = "Bersifat menyindir", optionB = "Lucu", optionC = "Membosangkan", answer = c),
    Question(question = "..... merupakan suatu riangkasan yang lengkap  dan menjelaskan keseluruhan isi artikel ilmiah dan di tempatkan pada bagian awal artikel ilmiah. Adalah pengertian", difficulty = medium, optionA = "Abstraksi", optionB = "Krisis", optionC = "Reaksi", answer = a),
    Question(question = "Persyaratan yang harus dimiliki oleh seseorang untuk bernegosiasi, adalah....", difficulty = medium, optionA = "Banyak berbicara yang tidak jelas", optionB = "Banyak kawan", optionC = "Mempunyai kemampuan berkomunikasi", answer = c),
    Question(question = "Berikut termasuk cara memperoleh bahan-bahan referensi untuk teks anekdot, keucali….", difficulty = hard, optionA = "Internet", optionB = "Imajinasi", optionC = "Lawakan", answer = b),
    Question(question = "Kalimat berikut yang termasuk unsur lucu/konyol/jengkel dari teks anekdot adalah…. ", difficulty = hard, optionA = "Perhatikan kehidupan orang miskin.", optionB = "Kesenangan sesaat akan menghancurkan masa depat.", optionC = "Ibu yang memuji tindakan anaknya yang salah.", answer = c),
    Question(question = "Cara mengevaluasi teks anekdot biasanya dilihat dari aspek….", difficulty = hard, optionA = "Makna tersirat", optionB = "Unsur kebahasannya", optionC = "Struktur teksnya", answer = a),
    Question(question = "Berikut ini termasuk pertanyaan-pertanyaan yang diajukan saat mengevaluasi teks ankedot, kecuali….", difficulty = hard, optionA = "Siapa partisipan/tokoh dalam teks tersebut?", optionB = "Apa yang dilakukan?", optionC = "Siapa yang kita sindir?", answer = b),
    Question(question = "Teks anekdot yang baik adalah teks yang memiliki….", difficulty = hard, optionA = "Unsur kebahasaan", optionB = "Struktur da nisi teks", optionC = "Unsur lucu/jengkel/konyol", answer = c)
